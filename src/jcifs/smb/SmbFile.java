...
import com.uninet.wirelessstore.SmbOpApi;
 ...
 */
    ...
    public boolean exists() throws SmbException {
        ...
        android.util.Log.d(SmbOpApi.TAG,"url = " + url.toString());
        try {
 ...
 */
    ...
    void doShareEnum(ArrayList list,
        ...
        android.util.Log.d(SmbOpApi.TAG,"urlstring = " + url.toString());
    ...
    void doNetServerEnum(ArrayList list,
        ...
        android.util.Log.d(SmbOpApi.TAG,"urlstring2 = " + url.toString());
        if (listType == 0) {
            connect0();
            ...
            for( int i = 0; i < resp.numEntries; i++ ) {
                ...
                if( name.length() < 3 ) {
                    ...
                    if( h == HASH_DOT || h == HASH_DOT_DOT ) {
                    	// [UNIPRO-pengzhaoyang-2014-8-1] for show ".." {
//                    	if (name.equals("."))
 ...
 */
    public void delete() throws SmbException {
    	android.util.Log.d(SmbOpApi.TAG,"unc = " + unc);
        exists();
        getUncPath0();
        delete( unc );
    }
